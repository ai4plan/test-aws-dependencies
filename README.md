...
```
    "@smithy/util-utf8": "4.2.0",                  npm info @smithy/util-utf8          version     4.2.0
    "@smithy/util-base64": "4.3.0",                npm info @smithy/util-base64        version     4.3.0
    "@smithy/is-array-buffer": "4.2.0",            npm info @smithy/is-array-buffer    version     4.2.0
    "@smithy/util-hex-encoding": "4.2.0",          npm info @smithy/util-hex-encoding  version     4.2.0
    "@smithy/types": "4.9.0",                      npm info @smithy/types              version     4.12.0   <---
    "@smithy/md5-js": "4.2.5",                     npm info @smithy/md5-js             version     4.2.8    <---
    "@smithy/util-buffer-from": "4.2.0",           npm info @smithy/util-buffer-from   version     4.2.0
    "fast-xml-parser": "5.2.5"                     npm info fast-xml-parser            version     5.3.7    <---
```
